class ApiResult {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.players != null) {
      data['items'] = this.players.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class ImageUrlsSize {
  ...
  ImageUrlsSize({this.small, this.medium, this.large});

  ImageUrlsSize.fromJson(Map<String, dynamic> json) {
    small = json['small'];
    medium = json['medium'];
    large = json['large'];
  }
...
class ImageUrlsTheme {
  ImageUrls dark;
  ImageUrls light;

  ImageUrlsTheme({this.dark, this.light});

  ImageUrlsTheme.fromJson(Map<String, dynamic> json) {
